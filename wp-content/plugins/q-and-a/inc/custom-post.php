	 ...
	 $labels = array(
  	...
  	register_post_type( 'qa_faqs',
		array(
			...
			'public' => true,
			'show_ui' => true,
			'capability_type' => 'qa_faqs',
			'capabilities' => array(
					'edit_post' => 'edit_qa_faqs',
					'read_post' => 'read_qa_faqs',
					'delete_post' => 'delete_qa_faqs',
					'read_others_posts' => 'read_others_qa_faqss',
					
					'edit_posts' => 'edit_qa_faqss',
					'edit_others_posts' => 'edit_others_qa_faqss',
					'edit_private_posts' => 'edit_private_qa_faqss',
					'edit_published_posts' => 'edit_published_qa_faqss',
									
					'publish_posts' => 'publish_qa_faqss',
					'read_private_posts' => 'read_private_qa_faqss',
					'delete_posts' => 'delete_qa_faqss',
					'delete_private_posts' => 'delete_private_qa_faqss',
					'delete_published_posts' => 'delete_published_qa_faqss',
					'delete_others_posts' => 'delete_others_qa_faqss',
			),			
...
function add_qa_faqs_caps() {
    // gets the administrator role
    $admins = get_role( 'administrator' );

	$admins->add_cap( 'manage_qa_faqs' );
    $admins->add_cap( 'edit_qa_faqs' ); 
    $admins->add_cap( 'edit_qa_faqss' ); 
    $admins->add_cap( 'edit_others_qa_faqss' ); 
    $admins->add_cap( 'publish_qa_faqss' );
    $admins->add_cap( 'edit_published_qa_faqss' ); 
    $admins->add_cap( 'read_qa_faqs' ); 
    $admins->add_cap( 'read_private_qa_faqss' ); 
    $admins->add_cap( 'delete_qa_faqs' );
    $admins->add_cap( 'delete_published_qa_faqss' );
    $admins->add_cap( 'delete_others_qa_faqss' );
    
    $admins->add_cap( 'manage_qa_faqs_tags' );
    $admins->add_cap( 'edit_qa_faqs_tags' );
    $admins->add_cap( 'delete_qa_faqs_tags' );
    $admins->add_cap( 'assign_qa_faqs_tags' );  
}
