...
function add_conference_caps() {
	...
	$admins->add_cap( 'manage_conference' );
	...
	$content_manager->add_cap( 'manage_conference' );
    $content_manager->add_cap( 'edit_conference' ); 
    $content_manager->add_cap( 'edit_conferences' ); 
    $content_manager->add_cap( 'edit_others_conferences' ); 
    $content_manager->add_cap( 'publish_conferences' );
    $content_manager->add_cap( 'edit_published_conferences' ); 
    $content_manager->add_cap( 'read_conference' ); 
    $content_manager->add_cap( 'read_private_conferences' ); 
    $content_manager->add_cap( 'delete_conference' );
    $content_manager->add_cap( 'delete_published_conferences' );
    $content_manager->add_cap( 'delete_others_conferences' );
    
    $content_manager->add_cap( 'manage_conference_tags' );
    $content_manager->add_cap( 'edit_conference_tags' );
    $content_manager->add_cap( 'delete_conference_tags' );
    $content_manager->add_cap( 'assign_conference_tags' ); 	
}
?>
