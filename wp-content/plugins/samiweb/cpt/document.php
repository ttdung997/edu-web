...
function add_document_caps() {
	...
	$admins->add_cap( 'manage_document' ); 
	...
	$content_manager->add_cap( 'manage_document' ); 
    $content_manager->add_cap( 'edit_document' ); 
    $content_manager->add_cap( 'edit_documents' ); 
    $content_manager->add_cap( 'edit_others_documents' ); 
    $content_manager->add_cap( 'publish_documents' );
    $content_manager->add_cap( 'edit_published_documents' ); 
    $content_manager->add_cap( 'read_document' ); 
    $content_manager->add_cap( 'read_private_documents' ); 
    $content_manager->add_cap( 'delete_document' );
    $content_manager->add_cap( 'delete_published_documents' );
    $content_manager->add_cap( 'delete_others_documents' );
    
    $content_manager->add_cap( 'manage_document_tags' );
    $content_manager->add_cap( 'edit_document_tags' );
    $content_manager->add_cap( 'delete_document_tags' );
    $content_manager->add_cap( 'assign_document_tags' );
}
?>
