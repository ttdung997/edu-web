...
$detai_meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'class' => 'full-width',
			'style' => 'max-width:100%',
			'placeholder' => 'Nhập tên đề tài vào đây'
		),
		// TEXT
		array(
			// Field name - Will be used as label
			...
			'clone' => false,
			'class' => 'full-width',
			'placeholder' => 'Nhập mã đề tài vào đây'
		),
		// text
		array(
			'name' => 'Loại đề tài',
		...
		array(
			...
			'placeholder' => 'Viết tóm tắt đề tài vào đây',
			'type' => 'wysiwyg',
			'cols' => 20,
			'rows' => 20,
		),
		...
		array(
			// Field name - Will be used as label
			'name'  => 'Các thành viên chính',
			// Field ID, i.e. the meta key
			'id'    => "{$prefix}key_members",
			// Field description (optional)
			'desc'  => 'Danh sách các thành viên chủ chốt thực hiện đề tài.',
			'type'  => 'text',
			// Default value (optional)
			//'std'   => '',
			// CLONES: Add to make the field cloneable (i.e. have multiple value)
			'clone' => false,
			'class' => 'full-width',
			'placeholder' => 'Nhập tên các thành viên chính'
		),
		//SELECT BOX
		array(
			'name'     => 'Năm bắt đầu',
