...
?>
	<div class="list-tab-event">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#tab-happening" data-toggle="tab"><?php esc_html_e( 'Đang diễn ra', 'eduma' ); ?></a></li>
			<li><a href="#tab-upcoming" data-toggle="tab"><?php esc_html_e( 'Sắp diễn ra', 'eduma' ); ?></a></li>
			<li><a href="#tab-expired" data-toggle="tab"><?php esc_html_e( 'Kết thúc', 'eduma' ); ?></a></li>
		</ul>
