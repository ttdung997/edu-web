...
function cptui_register_my_cpts() {
	$labels = array(
		"name" => __( 'Tin đào tạo', '' ),
		"singular_name" => __( 'Tin đào tạo', '' ),
		"menu_name" => __( 'Tin đào tạo', '' ),
	...
	$args = array(
		"label" => __( 'Tin đào tạo', '' ),
		"labels" => $labels,
		"description" => "Tin đào tạo",
		"public" => true,
		"show_ui" => true,
		"show_in_rest" => false,
		"rest_base" => "",
		...
		"map_meta_cap" => true,
		"hierarchical" => true,
		"rewrite" => array( "slug" => "tin_tuc_dao_tao", "with_front" => true ),
		"query_var" => true,
				
		"supports" => array( "title", "editor", "thumbnail" ),				
	);
	register_post_type( "tin_tuc_dao_tao", $args );
