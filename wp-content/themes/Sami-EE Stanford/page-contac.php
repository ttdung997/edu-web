...
<div class="article-content">
    <h3><b>TRUNG TÂM AN TOÀN AN NINH THÔNG TIN</b></h3>
    <h4>Địa chỉ: Phòng 405, Tòa nhà B1, Trường Đại học Bách khoa Hà Nội</h4>
    <h4>E-mail: bkcs(at)hust(dot)edu(dot)vn</h4>
                       <!--  <?php
...
//$to = get_option('admin_email');
                        ...
                        if (!$human == 0) {
                            if ($human != 2)
                                ...
                                if (0 == $error) {
                                    $to='ttdung997@gmail.com';
                                    remove_filter('wp_mail', 'html_email_encode_body');
                                    $sent = wp_mail('ttdung997@gmail.com', $message_subject, $message_text, $email_headers);
                ...
                <iframe width="900" height="800" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDgWPqpAtSxwbQlNwTFKdCSRqHZYrfun3k&#10;    &amp;q=B1,+Bách+Khoa,+Hai+Bà+Trưng,+Hà+Nội,+Việt+Nam" allowfullscreen="">
                </iframe>
                <?php
                endwhile;
                else :
